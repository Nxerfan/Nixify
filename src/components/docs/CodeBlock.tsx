...
export function CodeBlock({ label, code }: { label: string; code: string }) {
  ...
  return (
    <div className="mt-3 overflow-hidden rounded-lg border border-gray-800/60 bg-gray-950/40">
      ...
      <pre dir="ltr" className="overflow-auto p-3 text-xs leading-relaxed text-gray-300">
        <code>{code}</code>
      </pre>
    </div>
  );
