    ...
    >
      ...
      <div className="mb-6 grid gap-3 sm:grid-cols-2">
        ...
        >
          ...
          <p className="text-[12px] text-gray-300 leading-relaxed">{copy.fullCard.body}</p>
        ...
        >
          ...
          <p className="text-[12px] text-gray-300 leading-relaxed">{copy.readOnlyCard.body}</p>
          <ul className="mt-3 space-y-1">
      ...
      <div className="mb-3 flex items-start gap-2 rounded-xl border border-sky-500/30 bg-sky-500/5 p-3">
        ...
        <p className="text-[11px] text-gray-300">{copy.customScopesNote}</p>
      </div>
...
function ExampleRow({
  ...
  return (
    <motion.div
      ...
      className={`rounded-xl border ${accentBorder} bg-gray-950/40 p-3`}
    >
