    ...
    >
      ...
      <div className="mb-5 grid gap-3 sm:grid-cols-2">
        ...
        >
          ...
          <p className="text-xs text-muted-foreground">{copy.sendNowCard.body}</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-xs text-muted-foreground">{copy.scheduleCard.body}</p>
        </motion.div>
      </div>
      ...
      <div className="mb-4 flex items-start gap-2 rounded-xl border border-sky-500/30 bg-sky-500/5 p-3">
        ...
        <p className="text-xs text-muted-foreground">{copy.uiExposedNote}</p>
      </div>
