  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 pb-24 pt-28 sm:px-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground/50">Last updated: September 20, 2026</p>
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground">4. Infrastructure &amp; Subprocessors</h2>
