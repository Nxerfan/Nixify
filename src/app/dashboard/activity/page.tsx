    ...
    <>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-100">{t("dashboard.activity.title")}</h1>
            <p className="text-sm text-gray-500">{t("dashboard.activity.subtitle")}</p>
          </div>
        </div>
        <div className="rounded-xl border border-gray-800/40 bg-gray-950/40 p-8 text-center backdrop-blur-xl">
          <p className="text-sm text-gray-500">{t("dashboard.activity.empty")}</p>
        </div>
      </div>
    </>
  );
