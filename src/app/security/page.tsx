        ...
        <div className="mt-10 space-y-8">
          <section className="rounded-lg border border-border bg-card/60 p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              <li className="flex gap-2"><Lock className="mt-0.5 h-4 w-4 shrink-0 text-emerald-400" /><span>Codes are hashed with <strong className="text-foreground">HMAC-SHA256</strong> using a server-side pepper (<code dir="ltr" className="font-mono text-emerald-300">OTP_PEPPER</code>) before storage. Plaintext codes are never persisted.</span></li>
              <li className="flex gap-2"><Clock className="mt-0.5 h-4 w-4 shrink-0 text-emerald-400" /><span>Codes expire after <strong className="text-foreground">10 minutes</strong> and are <strong className="text-foreground">single-use</strong> — a verified code cannot be reused.</span></li>
              <li className="flex gap-2"><ShieldCheck className="mt-0.5 h-4 w-4 shrink-0 text-emerald-400" /><span>Maximum <strong className="text-foreground">5 verification attempts</strong> per code before per-code lockout.</span></li>
            </ul>
          </section>
          ...
          <section className="rounded-lg border border-border bg-card/60 p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              ...
              <li className="flex gap-2"><ShieldCheck className="mt-0.5 h-4 w-4 shrink-0 text-emerald-400" /><span>Keys support <strong className="text-foreground">full</strong> and <strong className="text-foreground">read_only</strong> scopes, optional expiration dates, and can be revoked.</span></li>
          ...
          <section className="rounded-lg border border-border bg-card/60 p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              <li className="flex gap-2"><Lock className="mt-0.5 h-4 w-4 shrink-0 text-emerald-400" /><span>Every delivery is signed with <strong className="text-foreground">HMAC-SHA256</strong> via the <code dir="ltr" className="font-mono text-emerald-300">Nixify-Signature</code> header.</span></li>
              <li className="flex gap-2"><Clock className="mt-0.5 h-4 w-4 shrink-0 text-emerald-400" /><span>Signatures include a timestamp with <strong className="text-foreground">5-minute replay tolerance</strong> — reject deliveries older than 5 minutes.</span></li>
              <li className="flex gap-2"><ShieldCheck className="mt-0.5 h-4 w-4 shrink-0 text-emerald-400" /><span><strong className="text-foreground">SSRF protection</strong>: webhook destination URLs are validated at creation and before every delivery; redirects are not followed.</span></li>
            </ul>
          </section>
          ...
          <section className="rounded-lg border border-border bg-card/60 p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              <li className="flex gap-2"><Lock className="mt-0.5 h-4 w-4 shrink-0 text-emerald-400" /><span><strong className="text-foreground">HTTPS enforced</strong> for all production traffic (Vercel TLS).</span></li>
              ...
              <li className="flex gap-2"><ShieldCheck className="mt-0.5 h-4 w-4 shrink-0 text-emerald-400" /><span>User passwords are hashed with <strong className="text-foreground">bcrypt (cost factor 12)</strong> — never stored in plaintext.</span></li>
            </ul>
          </section>
